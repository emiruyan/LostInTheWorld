...
namespace AlmostEngine.Screenshot
{
    ...
    public static class SimpleScreenshotCapture
    {
        ...
        public static void CaptureCameraToFile(string fileName,
                                   ...
                                   bool recomputeAlphaMask = false)
        {
            CaptureToFile(fileName, width, height, fileFormat, JPGQuality, new List<Camera> { camera }, null, ScreenshotTaker.CaptureMode.RENDER_TO_TEXTURE, antiAliasing, false, colorFormat, recomputeAlphaMask);
        }
        ...
        public static void CaptureCamerasToFile(string fileName,
                                           ...
                                           bool recomputeAlphaMask = false)
        {
            CaptureToFile(fileName, width, height, fileFormat, JPGQuality, cameras, null, ScreenshotTaker.CaptureMode.RENDER_TO_TEXTURE, antiAliasing, false, colorFormat, recomputeAlphaMask);
        }
        ...
        {
            InitScreenshotTaker();
            m_ScreenshotTaker.StartCoroutine(CaptureToFileCoroutine(fileName, width, height, fileFormat, JPGQuality, cameras, canvas, captureMode, antiAliasing, captureGameUI, colorFormat, recomputeAlphaMask));
        }
